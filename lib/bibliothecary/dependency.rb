...
module Bibliothecary
  ...
  # @attr_reader [String] platform The platform of the package, e.g. "maven". The analysis result will
  #   also return the platform, although it may be "sbom" for SBOM files when full_sbom: true.
