...
describe Bibliothecary::Parsers::NPM do
  ...
  context "with a yarn.lock" do
    let(:expected_deps) do
      [
        Bibliothecary::Dependency.new(platform: "npm", name: "body-parser", requirement: "1.16.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "bytes", requirement: "2.4.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "content-type", requirement: "1.0.2", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "debug", requirement: "2.6.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "depd", requirement: "1.1.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "ee-first", requirement: "1.1.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "http-errors", requirement: "1.5.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "iconv-lite", requirement: "0.4.15", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "inherits", requirement: "2.0.3", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "media-typer", requirement: "0.3.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "mime-db", requirement: "1.26.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "mime-types", requirement: "2.1.14", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "ms", requirement: "0.7.2", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "on-finished", requirement: "2.3.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "qs", requirement: "6.2.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "raw-body", requirement: "2.2.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "setprototypeof", requirement: "1.0.2", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "statuses", requirement: "1.3.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "@some-scope/actual-package", requirement: "1.1.3", original_name: "alias-package-name", original_requirement: "1.1.3", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "type-is", requirement: "1.6.14", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "unpipe", requirement: "1.0.0", type: "runtime", local: false, source: "yarn.lock"),
      ]
    end
  ...
  it "parses git dependencies from yarn.lock" do
    expect(described_class.analyse_contents("yarn.lock", load_fixture("yarn-with-git-repo/yarn.lock"))).to eq({
                                                                                                                ...
                                                                                                                project_name: nil,
                                                                                                                dependencies: [
          Bibliothecary::Dependency.new(platform: "npm", name: "vue", requirement: "2.6.12", type: "runtime", local: false, source: "yarn.lock"),
        ],
                                                                                                                kind: "lockfile",
                                                                                                                success: true,
                                                                                                              })
  ...
  context "with local path dependencies" do
    ...
    it "parses local path dependencies from yarn.lock" do
      expect(described_class.analyse_contents("yarn.lock", load_fixture("npm-local-file/yarn.lock"))).to eq({
                                                                                                              ...
                                                                                                              project_name: nil,
                                                                                                              dependencies: [
          Bibliothecary::Dependency.new(platform: "npm", name: "js-tokens", requirement: "4.0.0", type: "runtime", local: false, source: "yarn.lock"),
          Bibliothecary::Dependency.new(platform: "npm", name: "left-pad", requirement: "1.3.0", type: "runtime", local: false, source: "yarn.lock"),
          Bibliothecary::Dependency.new(platform: "npm", name: "loose-envify", requirement: "1.4.0", type: "runtime", local: false, source: "yarn.lock"),
          Bibliothecary::Dependency.new(platform: "npm", name: "other-package", requirement: "1.0.0", type: "runtime", local: true, source: "yarn.lock"),
          Bibliothecary::Dependency.new(platform: "npm", name: "react", requirement: "18.3.1", type: "runtime", local: false, source: "yarn.lock"),
        ],
                                                                                                              kind: "lockfile",
                                                                                                              success: true,
                                                                                                            })
  ...
  it "does not parse self-referential dependencies from yarn.lock" do
    expect(described_class.analyse_contents("yarn.lock", load_fixture("yarn-v4-lockfile/yarn.lock"))).to eq({
        ...
        Bibliothecary::Dependency.new(platform: "npm", name: "loose-envify", requirement: "1.4.0", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "react", requirement: "18.3.1", type: "runtime", local: false, source: "yarn.lock"),
        Bibliothecary::Dependency.new(platform: "npm", name: "strip-ansi", requirement: "6.0.1", original_name: "strip-ansi-cjs", original_requirement: "6.0.1", type: "runtime", local: false, source: "yarn.lock"),
      ],
                                                                                                              kind: "lockfile",
                                                                                                              success: true,
                                                                                                            })
  ...
  it "parses dependencies that have multiple versions in yarn.json" do
    expect(described_class.analyse_contents("yarn.lock", load_fixture("multiple_versions/yarn.lock"))).to eq({
                                                                                                               dependencies: [
                                                                                                                 Bibliothecary::Dependency.new(platform: "npm", name: "find-versions", requirement: "4.0.0", type: "runtime", local: false, source: "yarn.lock"),
                                                                                                                 Bibliothecary::Dependency.new(platform: "npm", name: "semver-regex", requirement: "3.1.3", type: "runtime", local: false, source: "yarn.lock"),
                                                                                                                 Bibliothecary::Dependency.new(platform: "npm", name: "semver-regex", requirement: "4.0.2", type: "runtime", local: false, source: "yarn.lock"),
                                                                                                               ],
                                                                                                               kind: "lockfile",
                                                                                                               path: "yarn.lock",
                                                                                                               project_name: nil,
