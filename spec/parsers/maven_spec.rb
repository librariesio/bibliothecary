...
RSpec.describe Bibliothecary::Parsers::Maven do
  ...
  it "parses dependencies from pom.xml" do
    expect(described_class.analyse_contents("pom.xml", load_fixture("pom.xml"))).to eq({
      ...
      path: "pom.xml",
      dependencies: [
        Bibliothecary::Dependency.new(name: "org.accidia:echo-parent",
        requirement: "0.1.23",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.core:jersey-server",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.containers:jersey-container-servlet",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.containers:jersey-container-servlet-core",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.media:jersey-media-multipart",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.core:jersey-common",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.containers:jersey-container-jetty-http",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.containers:jersey-container-jetty-servlet",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.core:jersey-client",
        requirement: "2.16",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.glassfish.jersey.media:jersey-media-moxy",
        requirement: "2.16",
        type: "runtime"),
        # version string from <dependencyManagement>, and interpolated from <properties>
        Bibliothecary::Dependency.new(name: "com.google.guava:guava", requirement: "18.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.googlecode.protobuf-java-format:protobuf-java-format",
        requirement: "1.2",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "mysql:mysql-connector-java",
        requirement: "5.1.9",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.springframework:spring-jdbc",
        requirement: "4.1.0.RELEASE",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.mchange:c3p0", requirement: "0.9.2.1", type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.freemarker:freemarker",
        requirement: "2.3.21",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.jasypt:jasypt", requirement: "1.9.2", type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.google.protobuf:protobuf-java",
        requirement: "2.5.0",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "redis.clients:jedis", requirement: "2.6.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "ch.qos.logback:logback-classic",
        requirement: "1.1.2",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "io.dropwizard.metrics:metrics-core",
        requirement: "3.1.0",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "net.spy:spymemcached", requirement: "2.11.7", type: "runtime"),
        Bibliothecary::Dependency.new(name: "io.dropwizard.metrics:metrics-jersey2",
        requirement: "3.1.0",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "io.dropwizard.metrics:metrics-annotation",
        requirement: "3.1.0",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.palominolabs.metrics:metrics-guice",
        requirement: "3.1.0",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.google.inject:guice", requirement: "3.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "commons-io:commons-io", requirement: "2.4", type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.apache.commons:commons-exec",
        requirement: "1.3",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.typesafe:config", requirement: "1.2.1", type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.testng:testng", requirement: "6.8.7", type: "test"),
        Bibliothecary::Dependency.new(name: "org.mockito:mockito-all", requirement: "1.8.4", type: "test"),
        Bibliothecary::Dependency.new(name: "io.libraries:bibliothecary", requirement: "${bibliothecary.version}", type: "test"),
        Bibliothecary::Dependency.new(name: "io.libraries:recursive", requirement: "${recursive.test}", type: "runtime"),
        Bibliothecary::Dependency.new(name: "io.libraries:optional", requirement: "${optional.test}", type: "runtime", optional: true),
        Bibliothecary::Dependency.new(name: "io.libraries:not-optional", requirement: "${not-optional.test}", type: "runtime", optional: false),
      ],
      kind: "manifest",
      success: true,
    })
      ...
      dependencies: [
        Bibliothecary::Dependency.new(name: "org.apache.maven:maven-plugin-api",
         ...
         Bibliothecary::Dependency.new(name: "org.apache.httpcomponents:httpmime",
          requirement: "4.5.2",
          type: "runtime"),
         Bibliothecary::Dependency.new(name: "org.testng:testng", requirement: "6.9.12", type: "test"),
      ],
      kind: "manifest",
      success: true,
    })
  ...
  it "parses dependencies from ivy.xml" do
    expect(described_class.analyse_contents("ivy.xml", load_fixture("ivy.xml"))).to eq({
      ...
      path: "ivy.xml",
      dependencies: [
        Bibliothecary::Dependency.new(name: "org.htmlparser:htmlparser", requirement: "2.1", type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.apache.velocity:velocity",
        requirement: "1.7",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "commons-lang:commons-lang", requirement: "2.6", type: "runtime"),
        Bibliothecary::Dependency.new(name: "commons-collections:commons-collections",
        requirement: "3.2.2",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.json:json", requirement: "20151123", type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.apache.ant:ant", requirement: "1.9.6", type: "runtime"),
        Bibliothecary::Dependency.new(name: "com.googlecode.java-diff-utils:diffutils",
        requirement: "1.3.0",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "junit:junit", requirement: "4.12", type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.mockito:mockito-core",
        requirement: "1.10.19",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.hamcrest:hamcrest-all", requirement: "1.3", type: "runtime"),
        Bibliothecary::Dependency.new(name: "net.javacrumbs.json-unit:json-unit",
        requirement: "1.1.6",
        type: "runtime"),
        Bibliothecary::Dependency.new(name: "org.mozilla:rhino", requirement: "1.7.7", type: "runtime"),
      ],
      kind: "manifest",
      success: true,
    })
  ...
  context "gradle" do
    it "parses various dependency syntax variations" do
      ...
      expect(described_class.analyse_contents("build.gradle", source)[:dependencies]).to match_array([
        Bibliothecary::Dependency.new(name: "com.whatever:liblib", requirement: "1.2.3", type: "compile"),
        Bibliothecary::Dependency.new(name: "this.is.a.group:greatlib", requirement: "*", type: "compile"),
        Bibliothecary::Dependency.new(name: "com.fasterxml.jackson.core:jackson-databind", requirement: "*", type: "compile"),
        Bibliothecary::Dependency.new(name: "this.thing:neat", requirement: "*", type: "compileOnly"),
        Bibliothecary::Dependency.new(name: "hello.there:im.a.dep", requirement: "$versionThing", type: "testCompile"),
        Bibliothecary::Dependency.new(name: "this.has:parens", requirement: "*", type: "compile"),
        Bibliothecary::Dependency.new(name: "junit:junit", requirement: "4.13.2", type: "compile"),
      ])
    end
    ...
    it "parses dependencies from build.gradle" do
      expect(described_class.analyse_contents("build.gradle", load_fixture("build.gradle"))).to eq({
        ...
        path: "build.gradle",
        dependencies: [
          Bibliothecary::Dependency.new(name: "com.squareup.okhttp:okhttp", requirement: "2.1.0", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.squareup.okhttp:okhttp-urlconnection", requirement: "2.1.0", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.squareup.picasso:picasso", requirement: "2.4.0", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.google.android.gms:play-services-wearable", requirement: "8.3.0", type: "compile"),
          Bibliothecary::Dependency.new(name: "de.greenrobot:eventbus", requirement: "2.4.0", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.android.support:appcompat-v7", requirement: "23.1.1", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.android.support:recyclerview-v7", requirement: "23.1.1", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.android.support:design", requirement: "23.1.1", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.android.support:customtabs", requirement: "23.1.1", type: "compile"),
          Bibliothecary::Dependency.new(name: "com.google.guava:guava", requirement: "${guavaVersions['latest']}", type: "implementation"),
        ],
        kind: "manifest",
        success: true,
      })
    ...
    it "parses dependencies from build.gradle.kts" do
      expect(described_class.analyse_contents("build.gradle.kts", load_fixture("build.gradle.kts"))).to eq({
        ...
        dependencies: [
          Bibliothecary::Dependency.new(name: "org.jetbrains.kotlin:kotlin-stdlib-jdk8", requirement: "*", type: "implementation"),
          Bibliothecary::Dependency.new(name: "com.google.guava:guava", requirement: "30.1.1-jre", type: "implementation"),
          Bibliothecary::Dependency.new(name: "org.jetbrains.kotlin:kotlin-test", requirement: "*", type: "testImplementation"),
          Bibliothecary::Dependency.new(name: "org.jetbrains.kotlin:kotlin-test-junit", requirement: "1.0.0", type: "testImplementation"),
          Bibliothecary::Dependency.new(name: "androidx.annotation:annotation", requirement: "${rootProject.extra[\"androidx_annotation_version\"]}", type: "implementation"),
        ],
        kind: "manifest",
        success: true,
      })
  ...
  it "parses dependencies from an ivy report for a root project / type compile" do
    expect(described_class.analyse_contents("com.example-hello_2.12-compile.xml", load_fixture("ivy_reports/com.example-hello_2.12-compile.xml"))).to eq({
      ...
      dependencies: [
        Bibliothecary::Dependency.new(name: "org.scala-lang:scala-library", requirement: "2.12.5", type: "compile"),
      ],
      kind: "lockfile",
      success: true,
    })
  ...
  it "parses dependencies from an ivy report for a subproject / type test" do
    expect(described_class.analyse_contents("com.example-subproject_2.12-test.xml", load_fixture("ivy_reports/com.example-subproject_2.12-test.xml"))).to eq({
      ...
      dependencies: [
        Bibliothecary::Dependency.new(name: "com.typesafe.akka:akka-stream_2.12", requirement: "2.5.6", type: "test"),
        Bibliothecary::Dependency.new(name: "com.typesafe:ssl-config-core_2.12", requirement: "0.2.2", type: "test"),
        Bibliothecary::Dependency.new(name: "org.scala-lang.modules:scala-parser-combinators_2.12", requirement: "1.0.4", type: "test"),
        Bibliothecary::Dependency.new(name: "org.reactivestreams:reactive-streams", requirement: "1.0.1", type: "test"),
        Bibliothecary::Dependency.new(name: "com.typesafe.akka:akka-actor_2.12", requirement: "2.5.6", type: "test"),
        Bibliothecary::Dependency.new(name: "org.scala-lang.modules:scala-java8-compat_2.12", requirement: "0.8.0", type: "test"),
        Bibliothecary::Dependency.new(name: "com.typesafe:config", requirement: "1.3.1", type: "test"),
        Bibliothecary::Dependency.new(name: "org.scala-lang:scala-library", requirement: "2.12.5", type: "test"),
      ],
      kind: "lockfile",
      success: true,
    })
  ...
  context "gradle" do
    ...
    it "has the correct sections and dependencies from gradle-dependencies-q.txt" do
      ...
      [
        Bibliothecary::Dependency.new(name: "commons-io:commons-io", requirement: "2.6", original_name: "apache:commons-io", original_requirement: "1.4"),
    ...
    it "includes aliases to local projects" do
      expect(described_class.parse_gradle_resolved("|    +--- my-group:common-job-update-gateway-compress:5.0.2 -> project :client (*)")).to eq [Bibliothecary::Dependency.new(
...
[\e[1;34mINFO\e[m] +- net.java.dev.javacc:javacc:jar:5.0:provided!)
      ...
      expect(output).to eq [
        ...
        Bibliothecary::Dependency.new(name: "net.sourceforge.pmd:pmd", requirement: "6.32.0-SNAPSHOT", type: "provided"),
        Bibliothecary::Dependency.new(name: "net.java.dev.javacc:javacc", requirement: "5.0", type: "provided"),
      ]
    end
