...
RSpec.describe Bibliothecary::Parsers::Maven do
  ...
  it "parses dependencies from ivy.xml" do
    expect(described_class.analyse_contents("ivy.xml", load_fixture("ivy.xml"))).to eq({
        ...
        Bibliothecary::Dependency.new(name: "commons-collections:commons-collections", requirement: "3.2.2", type: "runtime", source: "ivy.xml"),
        Bibliothecary::Dependency.new(name: "org.json:json", requirement: "20151123", type: "runtime", source: "ivy.xml"),
        Bibliothecary::Dependency.new(name: "org.apache.ant:ant", requirement: "1.9.6", type: "runtime", source: "ivy.xml"),
        Bibliothecary::Dependency.new(name: "com.googlecode.java-diff-utils:diffutils", requirement: "1.3.0", type: "runtime", source: "ivy.xml"),
        Bibliothecary::Dependency.new(name: "junit:junit", requirement: "4.12", type: "runtime", source: "ivy.xml"),
        Bibliothecary::Dependency.new(name: "org.mockito:mockito-core", requirement: "1.10.19", type: "runtime", source: "ivy.xml"),
        Bibliothecary::Dependency.new(name: "org.hamcrest:hamcrest-all", requirement: "1.3", type: "runtime", source: "ivy.xml"),
  ...
  context "gradle" do
    it "parses various dependency syntax variations" do
      ...
      expect(described_class.analyse_contents("build.gradle", source)[:dependencies]).to match_array([
        Bibliothecary::Dependency.new(name: "com.whatever:liblib", requirement: "1.2.3", type: "compile", source: "build.gradle"),
        Bibliothecary::Dependency.new(name: "this.is.a.group:greatlib", requirement: "*", type: "compile", source: "build.gradle"),
        Bibliothecary::Dependency.new(name: "com.fasterxml.jackson.core:jackson-databind", requirement: "*", type: "compile", source: "build.gradle"),
        Bibliothecary::Dependency.new(name: "this.thing:neat", requirement: "*", type: "compileOnly", source: "build.gradle"),
        Bibliothecary::Dependency.new(name: "hello.there:im.a.dep", requirement: "$versionThing", type: "testCompile", source: "build.gradle"),
        Bibliothecary::Dependency.new(name: "this.has:parens", requirement: "*", type: "compile", source: "build.gradle"),
        Bibliothecary::Dependency.new(name: "junit:junit", requirement: "4.13.2", type: "compile", source: "build.gradle"),
      ])
    end
    ...
    it "parses dependencies from build.gradle" do
      expect(described_class.analyse_contents("build.gradle", load_fixture("build.gradle"))).to eq({
          ...
          Bibliothecary::Dependency.new(name: "com.google.android.gms:play-services-wearable", requirement: "8.3.0", type: "compile", source: "build.gradle"),
          Bibliothecary::Dependency.new(name: "de.greenrobot:eventbus", requirement: "2.4.0", type: "compile", source: "build.gradle"),
          Bibliothecary::Dependency.new(name: "com.android.support:appcompat-v7", requirement: "23.1.1", type: "compile", source: "build.gradle"),
          Bibliothecary::Dependency.new(name: "com.android.support:recyclerview-v7", requirement: "23.1.1", type: "compile", source: "build.gradle"),
          Bibliothecary::Dependency.new(name: "com.android.support:design", requirement: "23.1.1", type: "compile", source: "build.gradle"),
  ...
  it "parses dependencies from an ivy report for a subproject / type test" do
    expect(described_class.analyse_contents("com.example-subproject_2.12-test.xml", load_fixture("ivy_reports/com.example-subproject_2.12-test.xml"))).to eq({
        ...
        Bibliothecary::Dependency.new(name: "org.reactivestreams:reactive-streams", requirement: "1.0.1", type: "test", source: "com.example-subproject_2.12-test.xml"),
        Bibliothecary::Dependency.new(name: "com.typesafe.akka:akka-actor_2.12", requirement: "2.5.6", type: "test", source: "com.example-subproject_2.12-test.xml"),
        Bibliothecary::Dependency.new(name: "org.scala-lang.modules:scala-java8-compat_2.12", requirement: "0.8.0", type: "test", source: "com.example-subproject_2.12-test.xml"),
