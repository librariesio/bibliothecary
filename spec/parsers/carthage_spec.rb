...
describe Bibliothecary::Parsers::Carthage do
  ...
  it 'parses dependencies from Cartfile.private' do
    ...
    expect(Bibliothecary::Parsers::Carthage.parse('Cartfile.private', file)).to eq([{:name=>"Quick/Quick", :version=>"~> 0.9", :type=>:runtime},
       {:name=>"Quick/Nimble", :version=>"~> 3.1", :type=>:runtime},
