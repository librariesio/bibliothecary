  ...
  it "parses dependencies from Cargo.lock" do
    expect(described_class.analyse_contents("Cargo.lock", load_fixture("Cargo.lock"))).to eq({
      ...
      dependencies:[
        ...
        Bibliothecary::Dependency.new(name: "memchr", requirement: "2.5.0", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "rand", requirement: "0.4.6", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "rand_core", requirement: "0.3.1", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "rand_core", requirement: "0.4.2", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "rdrand", requirement: "0.4.0", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "regex", requirement: "1.6.0", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "regex-syntax", requirement: "0.6.27", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "remove_dir_all", requirement: "0.5.3", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "rustc-serialize", requirement: "0.3.24", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "tempdir", requirement: "0.3.7", type: "runtime", source: "Cargo.lock"),
        Bibliothecary::Dependency.new(name: "winapi", requirement: "0.3.9", type: "runtime", source: "Cargo.lock"),
