...
describe Bibliothecary::Parsers::Elm do
  ...
  it "parses dependencies from elm-package.json" do
    expect(described_class.analyse_contents("elm-package.json", load_fixture("elm-package.json"))).to eq({
      ...
      dependencies: [
        Bibliothecary::Dependency.new(name: "evancz/elm-markdown", requirement: "1.1.0 <= v < 2.0.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "evancz/elm-html", requirement: "1.0.0 <= v < 2.0.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "evancz/local-channel", requirement: "1.0.0 <= v < 2.0.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "elm-lang/core", requirement: "1.0.0 <= v < 2.0.0", type: "runtime"),
      ],
      kind: "manifest",
      success: true,
    })
  ...
  it "parses dependencies from elm_dependencies.json" do
    expect(described_class.analyse_contents("elm_dependencies.json", load_fixture("elm_dependencies.json"))).to eq({
      ...
      dependencies: [
        Bibliothecary::Dependency.new(name: "johnpmayer/elm-webgl", requirement: "0.1.1", type: "runtime"),
        Bibliothecary::Dependency.new(name: "johnpmayer/elm-linear-algebra", requirement: "1.0.1", type: "runtime"),
      ],
      kind: "manifest",
      success: true,
    })
  ...
  it "parses dependencies from elm-stuff/exact-dependencies.json" do
    expect(described_class.analyse_contents("elm-stuff/exact-dependencies.json", load_fixture("exact-dependencies.json"))).to eq({
      ...
      dependencies: [
        Bibliothecary::Dependency.new(name: "jvoigtlaender/elm-drag-and-drop", requirement: "1.0.1", type: "runtime"),
        Bibliothecary::Dependency.new(name: "evancz/elm-html", requirement: "2.0.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "elm-lang/core", requirement: "1.1.1", type: "runtime"),
        Bibliothecary::Dependency.new(name: "evancz/automaton", requirement: "1.0.0", type: "runtime"),
        Bibliothecary::Dependency.new(name: "evancz/virtual-dom", requirement: "1.2.2", type: "runtime"),
      ],
      kind: "lockfile",
      success: true,
    })
