...
describe Bibliothecary::Parsers::Go do
  ...
  it 'parses dependencies from glide.yaml' do
    ...
    expect(Bibliothecary::Parsers::Go.parse('glide.yaml', file)).to eq([
  ...
  it 'parses dependencies from glide.lock' do
    ...
    expect(Bibliothecary::Parsers::Go.parse('glide.lock', file)).to eq([
  ...
  it 'parses dependencies from Godeps.json' do
    ...
    expect(Bibliothecary::Parsers::Go.parse('Godeps/Godeps.json', file)).to eq([
