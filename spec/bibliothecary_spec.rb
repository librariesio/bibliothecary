  ...
  it 'searches a folder for manifests and parses them' do
    expect(described_class.analyse('./')).to eq([
       ...
       {:platform=>"rubygems",
        :path=>"Gemfile.lock",
        :dependencies=>
         [{:name=>"bibliothecary", :requirement=>"4.0.4", :type=>"runtime"},
          ...
          {:name=>"rspec", :requirement=>"3.5.0", :type=>"runtime"},
          {:name=>"rspec-core", :requirement=>"3.5.4", :type=>"runtime"},
          {:name=>"rspec-expectations", :requirement=>"3.5.0", :type=>"runtime"},
          {:name=>"rspec-mocks", :requirement=>"3.5.0", :type=>"runtime"},
          {:name=>"rspec-support", :requirement=>"3.5.0", :type=>"runtime"},
